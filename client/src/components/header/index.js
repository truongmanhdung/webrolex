               ...
               <div class="navbar_right d-flex align-items-center color-menu ">
                 <div >
                   ...
                   <div class="showshearch">
                       <div class="container py-4">
                         ...
                         <div class="searchinput text-center d-flex">
                 ...
                 <div >
                   <label for="showBST" class="d-flex align-items-center ms-3 cursor-pointer">
                     ...
                     <p class="m-0 menu-margin  color-menu" >Bộ sưu tập của bạn</p>
                   </label>
                   <input type="checkbox" id="showBST" class="showBST" hidden>
                   <div class="showModalBST">
                       <div class="container py-4">
                         ...
                         <h3 class="text-center my-5">Bộ sưu tập của bạn</h3>
                       </div>
